...
urlpatterns = [
    ...
    path('<int:tournament_id>/deregister_team/', views.deregister_team_view, name='deregister_team'),
    path('<int:tournament_id>/remove_team/<int:team_id>/', views.remove_team_view, name='remove_team'),
]